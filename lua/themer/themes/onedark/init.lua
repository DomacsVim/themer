...
function M.colorscheme()
    ...
    require('themer.themes.onedark.highlights').setup()
    require('themer.themes.onedark.terminal').setup()
end
...
function M.setup(opts)
    ...
    if vim.g.onedark_config.toggle_style_key then
      vim.api.nvim_set_keymap('n', vim.g.onedark_config.toggle_style_key, '<cmd>lua require("themer.themes.onedark").toggle()<cr>', { noremap = true, silent = true })
    end
end
