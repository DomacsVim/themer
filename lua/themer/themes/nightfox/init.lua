...
if is_vim then
  require("themer.themes.nightfox.lib.vim")
end
...
function M.compile()
  local compiler = require("themer.themes.nightfox.lib." .. (is_vim and "vim." or "") .. "compiler")
  local foxes = require("themer.themes.nightfox.palette").foxes
...
function M.reset()
  require("themer.themes.nightfox.config").reset()
  require("themer.themes.nightfox.override").reset()
end
...
function M.setup(opts)
  ...
  local override = require("themer.themes.nightfox.override")
  ...
  local fingerprint = require("themer.themes.nightfox.fingerprint")
  ...
  require("themer.themes.nightfox.util.deprecation").check_deprecation(opts)
end
