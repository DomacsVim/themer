...
function M.load(name)
  local ovr = require("themer.themes.nightfox.override").palettes
  ...
  if name then
    ...
    local raw = valid and require("themer.themes.nightfox.palette." .. name) or require("themer.themes.nightfox.palette.nightfox")
    ...
    for _, mod in ipairs(M.foxes) do
      local raw = require("themer.themes.nightfox.palette." .. mod)
      local palette = raw.palette
      palette = apply_ovr("all", palette)
