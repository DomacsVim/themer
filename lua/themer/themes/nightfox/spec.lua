...
function M.load(name)
  local ovr = require("themer.themes.nightfox.override").specs
  ...
  if name then
    local palette = require("themer.themes.nightfox.palette").load(name)
    ...
    for _, mod in ipairs(foxes) do
      local palette = require("themer.themes.nightfox.palette").load(mod)
      local spec = palette.generate_spec(palette)
      spec = apply_ovr("all", spec, palette)
