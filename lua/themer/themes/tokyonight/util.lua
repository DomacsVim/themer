local ts = require("themer.themes.tokyonight.treesitter")
...
function M.invert_color(color)
  local hsluv = require("themer.themes.tokyonight.hsluv")
  if color ~= "NONE" then
...
function M.autocmds(config)
  vim.cmd([[augroup TokyoNight]])
  vim.cmd([[  autocmd!]])
  vim.cmd([[  autocmd ColorSchemePre * lua require("themer.themes.tokyonight.util").onColorScheme()]])
